# Nano Banana Pro API (nano-banana-pro / nanobananapro) — prompts guide with published pricing
...
**[Live pricing](https://go.apimart.ai/k-31cbf8)** · **[Get an API key](https://go.apimart.ai/k-ff6478)**
